...
export const projects: Project[] = [
  ...
  {
    id: 25,
    title: "ForgeUI - Frontend Builder Studio",
    description: "A visual frontend builder studio for configuring plugins and generating Next.js projects. Features project scaffolding, plugin management, layout editor, and file drift detection with re-sync capabilities.",
    techStack: ["Next.js", "React", "TypeScript", "CLI", "shadcn/ui", "Zustand", "TanStack Query"],
    imageTitle: "Build Next.js Projects Visually",
    imageDescription: "Configure plugins, scaffold projects, and manage layouts through an intuitive studio interface with real-time preview and managed file synchronization.",
    imageUrl: "/forgeui/1.png",
  ...
  {
    id: 26,
    title: "MarketLocal - Local Marketplace App UI/UX",
    description: "A mobile marketplace application UI/UX design for discovering and purchasing local products. Includes authentication flows, product browsing, location-based recommendations, checkout, and order confirmation.",
    techStack: ["Figma", "Mobile Design", "UI/UX"],
    imageTitle: "Belanja Produk Lokal dengan Mudah",
    imageDescription: "Temukan produk berkualitas dari penjual lokal terdekat dengan pengalaman belanja mobile yang intuitif, mulai dari login hingga checkout dan konfirmasi pesanan.",
    imageUrl: "/local-market/1.png",
    buttonText: "View Design",
    detailUrl: "#",
    category: "uiux",
  },
  {
    id: 27,
    title: "PG Disburse - Payment Gateway Admin Dashboard",
    description: "A comprehensive payment gateway and disbursement admin dashboard with transaction analytics, pay-in/pay-out management, settlement history, merchant rankings, and real-time financial reporting.",
    techStack: ["React.js", "TypeScript", "Tailwind CSS", "Chart.js"],
    imageTitle: "Complete Payment Operations Control",
    imageDescription: "Monitor daily transactions, track success rates, manage settlements, and oversee merchant operations with comprehensive analytics and role-based dashboard access.",
    imageUrl: "/pg-disburse/1.png",
    buttonText: "View Dashboard",
    detailUrl: "#",
    category: "frontend",
  },
  {
    id: 28,
    title: "QA Automation - Flypay E2E Testing",
    description: "End-to-end test automation suite for Flypay payment gateway dashboard using Playwright. Covers authentication, sidebar access control, security bypass checks, and transaction modules for both internal and merchant roles.",
    techStack: ["Playwright", "TypeScript", "E2E Testing", "QA Automation"],
    imageTitle: "Automated Quality Assurance",
    imageDescription: "Ensure dashboard reliability with structured test modules for login flows, role-based sidebar security, and pay-in transaction validation across internal and merchant environments.",
    imageUrl: "/qa-automation/1.png",
  ...
  {
    id: 29,
    title: "Workbloom - Freelancer Platform",
    description: "A modern freelancer platform that connects businesses with talented professionals across design, writing, app development, and more. Features a responsive landing page with clear navigation, category browsing, and seamless onboarding flow.",
    techStack: ["Next.js", "React", "TypeScript", "Tailwind CSS"],
    imageTitle: "Temukan Freelancer Terbaik untuk Bisnis Anda",
    imageDescription: "Hubungkan bisnis dengan para profesional berbakat di berbagai bidang — dari desain, penulisan, hingga pengembangan aplikasi — semua dalam satu platform.",
    imageUrl: "/workblom/1.png",
